const i18n = {
  en: {
    ...
    "nav.contact": "Contact",
    "toggle.theme": "Theme",
    "status.heading": "Now / Focus",
    "status.availability.label": "Availability",
    "status.availability.value": "Taking one automation client for Q1’26",
    "status.stack.label": "Stack",
    "status.projects.label": "Current build",
    "status.projects.value": "LLM ops dashboard + SimpleProcess automations",
  ...
  ru: {
    ...
    "nav.contact": "Контакт",
    "toggle.theme": "Тема",
    "status.heading": "Сейчас / Фокус",
    "status.availability.label": "Доступность",
    "status.availability.value": "Готов взять одного клиента по автоматизации в Q1’26",
    "status.stack.label": "Стэк",
    "status.projects.label": "Текущий проект",
    "status.projects.value": "Дашборд LLM-операций + SimpleProcess-автоматизации",
